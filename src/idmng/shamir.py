...
# The following code has part borrowed and modified form wiki
...
def make_shares(data, minimum, shares, prime=_PRIME):
    ...
    points.
    """
    if minimum > shares or not isinstance(data, int):
        raise ValueError("Pool secret would be irrecoverable.")
    poly = [data] + [_RINT(prime - 1) for i in range(minimum - 1)]
