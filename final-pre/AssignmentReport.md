...
The entire front-end system contains:
   ...
   -  `bfmng`: A storage component
         ...
         -  `bloomfilter.py` implements the basic data structure of the BloomFilter class. The underlying implementation is using an array of unsigned char types and some basic algorithms for manipulating the data structure such as union or insert. By default, it uses `murmurhash3` as the hash function.
